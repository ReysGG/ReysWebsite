export function BlogTagsField({ defaultValue = [] }: { defaultValue?: string[] }) {
  return (
    <div className="space-y-2">
      ...
      <input name="tags" defaultValue={defaultValue.join(", ")} placeholder="nextjs, seo, design" className="w-full rounded-md border border-neutral-200 px-3 py-2 text-sm outline-none focus:border-indigo-400" />
