export function BlogHero({ totalPosts }: { totalPosts: number }) {
  return <section className="mb-10 grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-end">
    <div>
      <p className="mb-4 bg-gradient-to-r from-[#ff8a00] via-[#f4b738] to-[#ffcd80] bg-clip-text text-xs font-bold uppercase tracking-[0.28em] text-transparent">Blog & Insights</p>
    ...
    <div className="rounded-3xl border border-[#ffcd80] bg-white/80 p-6 shadow-sm">
      ...
      <p className="mt-4 text-sm font-bold bg-gradient-to-r from-[#ff8a00] via-[#f4b738] to-[#ffcd80] bg-clip-text text-transparent">{totalPosts} artikel dipublikasikan</p>
    </div>
  </section>;
}
