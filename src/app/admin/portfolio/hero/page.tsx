    ...
    <div className="space-y-6">
      <div className="rounded-md border border-neutral-200 bg-white p-6 shadow-none">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-indigo-600">Portfolio Intro</p>
        ...
        <aside className="space-y-4">
          <div className="rounded-md border border-neutral-200 bg-white p-5 shadow-none">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-indigo-600">Preview Intro</p>
            ...
            <div className="mt-5 overflow-hidden rounded-2xl border border-neutral-200 bg-[#f5f3ff] p-6">
              <div className="rounded-2xl border border-white/70 bg-white/70 p-6 backdrop-blur">
                <p className="mb-4 text-xs font-bold uppercase tracking-widest text-indigo-600">{intro.eyebrow}</p>
