      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        <form action={savePromoBanner} className="space-y-6 rounded-md border border-neutral-200 bg-white p-6 shadow-none">
          ...
          <section className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1.5"><label className={labelClass} htmlFor="variant">Warna</label><select id="variant" name="variant" defaultValue={banner.variant} className={inputClass}><option value="orange">Orange</option><option value="amber">Amber</option><option value="emerald">Cream</option><option value="neutral">Neutral</option></select></div>
